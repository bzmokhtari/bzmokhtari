...
```
Firmware Architecture    IoT & Connected Devices    Wi-Fi 5/6/7    Matter Protocol
Embedded C/C++           RTOS                       WPA3 Security  FTM/RTT Ranging
MLME / MAC Layer         FSM Design                 Wireshark      CI/CD Pipelines
```

### Key Numbers

- **528+** commits and **441+** features delivered at Samsung across Wi-Fi stack
- **4x** connection capacity achieved under embedded memory constraints
- **95%+** first-time fix rate for complex cross-layer firmware issues
